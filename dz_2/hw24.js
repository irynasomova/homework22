...
var value_bak = parseInt(prompt("Enter the value of bak: "));
var value_initial = parseInt(prompt("Enter the initial value of bak: "));
...
if (value_bak>max_value) alert ("Invalid input");
...
if (weight_cargo<5) {
	...
	else (value_initial<rashod_fuel_5) { //вычисление недостающего объема топлива
		var rest_fuel_5 = rashod_fuel_5 - value_initial;
		alert("your plane will not reach. You need "+rest_fuel_5+" litrs for refueling");
	}
}
...
if (weight_cargo<4) {
	...
	else (value_initial<rashod_fuel_4) {
		var rest_fuel_4 = rashod_fuel_4 - value_initial;
		alert("your plane will not reach. You need "+rest_fuel_4+" litrs for refueling");
	}
}
...
if (weight_cargo<3) {
	...
	else (value_initial<rashod_fuel_3) {
		var rest_fuel_3 = rashod_fuel_3 - value_initial;
		alert("your plane will not reach. You need "+rest_fuel_3+" litrs for refueling");
	}
}
...
if (weight_cargo<2) {
	...
	else (value_initial<rashod_fuel_2) {
		var rest_fuel_2 = rashod_fuel_2 - value_initial;
		alert("your plane will not reach. You need "+rest_fuel_2+" litrs for refueling");
	}
}
...
if (weight_cargo<1) {
	...
	else (value_initial<rashod_fuel_1) {
		var rest_fuel_1 = rashod_fuel_1 - value_initial;
		alert("your plane will not reach. You need "+rest_fuel_1+" litrs for refueling");
	}
}
